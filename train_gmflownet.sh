...
python -u train.py --model gmflownet --name gmflownet-carla --stage carla --validation carla --restore_ckpt pretrained_models/gmflownet-kitti.pth --gpus 0 --num_steps 50000 --batch_size 1 --lr 0.0001 --image_size 160 240 --wdecay 0.00001 --gamma=0.85
